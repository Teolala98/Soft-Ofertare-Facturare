...
public class TeavaPatrata extends Material implements CalculMaterial {
    ...
    public TeavaPatrata(double latura, double grosime, double lungime, double pretML) {
        this.latura = latura;
    ...
    public double calcSuprafata() {
        return latura * latura * lungime / 1000000;
    }
    ...
    public double getPretML() {
        return pretML;
    }

    public void setPretML(double pretML) {
        this.pretML = pretML;
    }
}